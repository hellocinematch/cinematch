...
- **`package.json`:** **5.6.1** — circle **rating publish** + Recent strip / copy updates; see **`CHANGELOG.md`** and **`PASSDOWN-NEXT-CHAT.md`**.
...
Expected: match **`package.json`** (e.g. **`"version": "5.6.1"`**).
